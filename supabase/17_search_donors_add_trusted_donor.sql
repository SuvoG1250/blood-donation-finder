-- Extend public.search_donors to return trusted_donor flag.

drop function if exists public.search_donors(text, text, text, text);
...
begin
  ...
  select
    ...
    coalesce(m.trusted_donor, false) as trusted_donor
  from public.donors d
  left join public.donor_verification_metadata m
    on m.donor_user_id = d.user_id;
end;
$$;
