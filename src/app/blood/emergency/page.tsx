...
export default function EmergencyPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    const blockName = loc.block.trim();
    const panchayatName = loc.panchayat.trim();
    ...
    const addrCheck = validateWbAddressForSearch(loc, { requirePanchayat: true });
    if (!addrCheck.ok) {
      setLoading(false);
      alert(addrCheck.error ?? "Please complete the address using PIN or post office search.");
      return;
    }
