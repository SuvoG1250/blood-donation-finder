        ...
        <nav className="fixed inset-x-0 bottom-0 z-50 border-t bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 md:hidden">
          <div className="mx-auto flex w-full max-w-6xl items-center justify-around px-3 py-2">
            ...
            >
              <span
                aria-hidden="true"
                className="relative inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-emerald-500/10 ring-1 ring-emerald-500/20"
              >
                <span className="absolute inset-0 rounded-2xl bg-emerald-500/25 opacity-70 animate-ping" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="none"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="relative h-4 w-4 text-emerald-700"
                >
                  <path d="M12 2l7 4v6c0 5-3 9-7 10-4-1-7-5-7-10V6l7-4Z" />
                  <path d="M9 12l2 2 4-5" />
                </svg>
                <span className="pointer-events-none absolute -bottom-0.5 left-1/2 -translate-x-1/2 text-[10px] font-bold text-emerald-800">
                  ADM
                </span>
              </span>
              Admin
